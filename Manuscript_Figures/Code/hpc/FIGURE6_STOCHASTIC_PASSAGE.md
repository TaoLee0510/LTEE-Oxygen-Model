# Figure6 v4: reproducible threshold-triggered stochastic passage

Scope: iteration4 Figure6 and related supplements only. Figure6 and manuscript
...
repository `Model/oxygen/code/O2_supply_demand_MAP` model and the supplied latest fitting roots.
...
variant exists. Main Figure6B uses the existing display subset and layout;
Supp6-12 shows full-range passage; Supp6-13 diagnoses trajectories, integer-day
...
Use run_figure6_stochastic_campaign_hpc.sh RUN_ID BASELINE_RUN on hpctpa3pc0028.
...
Actual repository Model matrices are tested on HPC. Final visual inspection and
